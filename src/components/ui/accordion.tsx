...
function AccordionTrigger({
    ...
    return (
        <AccordionPrimitive.Header className="flex">
            ...
            >
                {children}
                <HugeiconsIcon icon={ChevronDown} data-slot="accordion-trigger-icon" className="pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden" />
                <HugeiconsIcon icon={ChevronUp} data-slot="accordion-trigger-icon" className="pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline" />
            </AccordionPrimitive.Trigger>
